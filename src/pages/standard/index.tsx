...
export default function SignupFormDemo() {
  ...
  return (
    ...
    <div className="max-w-md w-full my-6 mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input h-full  bg-gray-200  bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-80 border border-gray-100">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-4">
                ...
                <select id="destination" className="mt-1 block w-full pl-3 pr-10 py-2 text-base text-neutral-400 border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
